...
namespace FirstApp.Infrustracture.Migrations
{
    ...
    [Migration("20230918095500_initials")]
            ...
            modelBuilder.Entity("FirstApp.Model.Country", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTimeOffset(new DateTime(2023, 9, 18, 15, 54, 59, 918, DateTimeKind.Unspecified).AddTicks(6466), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "HHH",
                            Stutas = 1
                        },
                        new
                        {
                            Id = 2,
                            CountryName = "India",
                            Created = new DateTimeOffset(new DateTime(2023, 9, 18, 15, 54, 59, 918, DateTimeKind.Unspecified).AddTicks(6516), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "lkjhg",
                            Stutas = 1
                        });
                });
            ...
            modelBuilder.Entity("FirstApp.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 9, 18, 15, 54, 59, 922, DateTimeKind.Unspecified).AddTicks(6949), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "H",
